...
import { donateSpecialStickers } from '../../../redux/actions/stickers';
...
export default function Confirmation() {
	...
	async function handleSubmit() {
		...
		try {
			dispatch(await donateSpecialStickers(cards, targetId));
	...
	return (
		<div className={style.root}>
			<div className={style.title}>Confira se essas são as cartas especiais que você quer doar</div>
